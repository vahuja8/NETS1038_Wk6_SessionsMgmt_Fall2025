...
/*
 * adding the import library for hashing - date Oct -7-2025
 */
import com.va.week3.ServletSessions.hash.Md5HashingClass;
...
public class FirstServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * Hash the value of username prior to sending it to sessions.. 	
		 */
